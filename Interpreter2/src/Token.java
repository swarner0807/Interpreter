...
public class Token {
    ...
    public String[] keywords = { "=", "(", ")", "output", "if", "end", "quit", "sub", "call"};
    public String[] operators = { "+", "-", "*", "/" };    
    public static enum Type {
        KEYWORD, OPERATOR, IDENTIFIER, INTEGER, STRING, UNKNOWN
    }
    ...
    public Token.Type getType() {
        ...
        else if (Character.isDigit(this.strVal.charAt(0)) || (this.strVal.startsWith("-"))) {
